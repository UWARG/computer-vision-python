...
class AutoLanding:
    ...
    def create(
        ...
        return True, AutoLanding(cls.__create_key, fov_x, fov_y, im_h, im_w, local_logger, selection_strategy)
    ...
    def _select_detection(self, detections: list) -> Optional[int]:
        ...
        if self.__selection_strategy == DetectionSelectionStrategy.FIRST_DETECTION:
            ...
            for i, detection in enumerate(detections):
                ...
                distance = math.sqrt((det_center_x - image_center_x)**2 + (det_center_y - image_center_y)**2)
...
class AutoLandingController:
    ...
    def process_detections(
        self, 
        odometry_detections: merged_odometry_detections.MergedOdometryDetections
    ) -> "tuple[bool, AutoLandingInformation | None]":
        """
