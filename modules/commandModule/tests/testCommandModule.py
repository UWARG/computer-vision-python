...
class mockCommandModule:
    ...
    def __init__(self, pogiFileDirectory: str):
        ...
        self.__pogiData['gpsCoordinates'] = [random.uniform(-90, 90), random.uniform(-180, 180), random.uniform(0, 100)]
        self.__pogiData['currentAirspeed'] = [round(random.uniform(0, 50), 7)]
        self.__pogiData['eulerAnglesOfPlane'] = [random.uniform(0, math.pi * 2), random.uniform(0, math.pi * 2), random.uniform(0, math.pi * 2)]
        self.__pogiData['eulerAnglesOfCamera'] = [random.uniform(0, math.pi * 2), random.uniform(0, math.pi * 2), random.uniform(0, math.pi * 2)]
