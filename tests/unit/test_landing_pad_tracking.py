...
class TestSimilar:
    ...
    def test_is_similar_positive_equal_to_threshold(self) -> None:
        ...
        """
        result, obj_1 = object_in_world.ObjectInWorld.create(0, 0, 0)[1]
        assert result
        assert obj_1 is not None

        result, obj_2 = object_in_world.ObjectInWorld.create(1, 1, 0)[1]
        assert result
        assert obj_2 is not None
    ...
    def test_is_similar_positive_less_than_threshold(self) -> None:
        ...
        result, obj_2 = object_in_world.ObjectInWorld.create(0.5, 0.5, 0)[1]
        assert result
        assert obj_2 is not None
    ...
    def test_is_similar_positive_more_than_threshold(self) -> None:
        ...
        result, obj_2 = object_in_world.ObjectInWorld.create(2, 2, 0)[1]
        assert result
        assert obj_2 is not None
