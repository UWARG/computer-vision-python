...
class MockLogger:
    ...
    def info(self, message, print_to_console=False):
        if print_to_console:
            pass  # Suppress log output during testing
    
    def warning(self, message, print_to_console=False):
        if print_to_console:
            pass  # Suppress log output during testing
    
    def error(self, message, print_to_console=False):
        if print_to_console:
            pass  # Suppress log output during testing


def mock_logger_create(name, enable_file_logging):
...
def test_worker_multiple_detections():
...
def test_worker_invalid_commands():
