...
# def create_mock_merged_detections(
#     detections_list: list[tuple[float, float, float, float, float]], down_position: float = -10.0
# ) -> merged_odometry_detections.MergedOdometryDetections:
